...
def test_get_namespace(xml_element_with_namespace: ET.Element) -> None:
    namespace = get_namespace(xml_element_with_namespace)
    assert namespace == "{http://www.openarchives.org/OAI/2.0/}"


def test_get_namespace_without_namespace(xml_element_without_namespace: ET.Element) -> None:
    namespace = get_namespace(xml_element_without_namespace)
    assert namespace is None


def test_xml_to_dict_default(xml_element_with_namespace: ET.Element) -> None:
    result = xml_to_dict(xml_element_with_namespace)
    expected = {"{http://www.openarchives.org/OAI/2.0/}request": ["https://zenodo.org/oai2d"]}
    assert result == expected


def test_xml_to_dict_with_paths(xml_element_with_namespace: ET.Element) -> None:
...
def test_xml_to_dict_with_nsmap(xml_element_with_namespace: ET.Element) -> None:
...
def test_xml_to_dict_strip_namespace(xml_element_with_namespace: ET.Element) -> None:
